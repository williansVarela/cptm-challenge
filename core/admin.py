...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('name', 'email', 'cpf', 'password', 'date_of_birth', 'role')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('name', 'email', 'cpf', 'date_joined', 'is_admin')
    list_filter = ('is_admin',)
    fieldsets = (
        ('Profissional', {'fields': ('role',)}),
        ('Informações Pessoais', {'fields': ('name', 'email', 'date_of_birth', 'cpf', 'password')}),
